...
```
## Error in download.file(fileUrl, destfile = paste0(getwd(), "/repdata%2Fdata%2Factivity.zip"), : 'curl' call had nonzero exit status
```
...
```
## Warning in unzip("repdata%2Fdata%2Factivity.zip", exdir = "data"): error 1
...
# mean and median steps taken / day
